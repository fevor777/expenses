...
export function registerGetCurrentTimeTool(server, deps) {
    server.registerTool('get_current_time', {
        description: 'Return the current time formatted for a required IANA time zone. This tool requires a timezone input.',
...
function formatDateTimeInTimeZone(date, timezone) {
    ...
    const values = Object.fromEntries(dateParts
