...
@Component({
    ...
    <div class="composition-grid">
      <div class="chart-wrapper">
        ...
        <div class="chart" #treemapContainer aria-label="Treemap категорий"></div>
      </div>
    </div>
  `,
    styles: [
        `.composition-grid{display:block;}
   .chart-wrapper{background:#fff;border:1px solid #eee;border-radius:6px;padding:4px 6px 8px 6px;box-shadow:0 1px 2px rgba(0,0,0,0.05);}
   .chart-title{font-size:12px;font-weight:600;margin:2px 0 4px 2px;color:#555;}
...
export class CompositionChartsComponent implements OnChanges, AfterViewInit {
    ...
    constructor(private el: ElementRef, private analytics: CategoryAnalyticsService) { }
